...
Если достпу до СУ осуществляется через ssh/teleport проброс то в **WEB** версии в окне подключения необходимо указать **https://host.docker.internal:ноемр_порта**
